...
import "./Home.css";
import germany from "../../assets/germany2.jpeg";
              ...
              <Carousel className="home-carousel">
                <Carousel.Item interval={5000}>
                  ...
                  <Carousel.Caption>
                    ...
                    <p>
                      Discover the beauty of the world with our exclusive tours.
                    </p>
                  </Carousel.Caption>
                </Carousel.Item>
      ...
      <section className="home-services">
        <Container>
            ...
            <Col md={4}>
              <Card>
                ...
                <Card.Body className="bg-dark text-warning">
                  ...
                  <Card.Text>
                    Discover the vibrant life of bustling cities.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
          ...
          <p>
            ...
            beaches, iconic landmarks, and seamless transport come together for
          ...
          <Row>
            ...
            <Col md={4}>
              <Card>
                <Card.Body className="bg-dark text-warning">
                  <Card.Text>
                    "A truly unforgettable journey. Will travel again.
                    Wanderlust made planning my vacation effortless. Their
                    suggestions were fantastic, and the attention to detail was
                    remarkable.
                  </Card.Text>
                  <FontAwesomeIcon icon={faQuoteRight} />
                  <Card.Footer>
